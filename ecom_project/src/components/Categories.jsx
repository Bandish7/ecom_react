                        ...
                        <div className="absolute flex space-x-8 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
                            <a href="#" className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                <span aria-hidden="true" className="absolute inset-0">
                                    <Pictures imageUrl="https://tailwindui.com/img/ecommerce-images/home-page-01-category-01.jpg" imageName="New Arrivals" className="h-full w-full object-cover object-center" />
                                </span>
                            ...
                            <a href="#" className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                <span aria-hidden="true" className="absolute inset-0">
                                    <Pictures imageUrl="https://tailwindui.com/img/ecommerce-images/home-page-01-category-02.jpg" imageName="Productivity" className="h-full w-full object-cover object-center" />
                                </span>
                                <span aria-hidden="true" className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"></span>
                            ...
                            <a href="#" className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                <span aria-hidden="true" className="absolute inset-0">
                                    <Pictures imageUrl="https://tailwindui.com/img/ecommerce-images/home-page-01-category-04.jpg" imageName="Workspace" className="h-full w-full object-cover object-center" />
                                </span>
                                <span aria-hidden="true" className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"></span>
                            ...
                            <a href="#" className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                <span aria-hidden="true" className="absolute inset-0">
                                    <Pictures imageUrl="https://tailwindui.com/img/ecommerce-images/home-page-01-category-05.jpg" imageName="Accessories" className="h-full w-full object-cover object-center" />
                                </span>
                                <span aria-hidden="true" className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"></span>
                            ...
                            <a href="#" className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                <span aria-hidden="true" className="absolute inset-0">
                                    <Pictures imageUrl="https://tailwindui.com/img/ecommerce-images/home-page-01-category-03.jpg" imageName="Sale" className="h-full w-full object-cover object-center" />
                                </span>
                                <span aria-hidden="true" className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800 opacity-50"></span>
