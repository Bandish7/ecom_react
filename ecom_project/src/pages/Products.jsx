...
export default function Products() {
  ...
  function addToCart() {
   ...
   const existingItem cartValue.find(item => (item.category === currentCategory.id) &&  (item.product === currentProduct.id));
        ...
        >
          <ol role="list" className="flex items-center space-x-4 py-8">
            ...
            <li className="text-sm">
              <Link
                to={`/categories/${currentCategory.id}/products/${currentProduct.id}`}
                aria-current="page"
