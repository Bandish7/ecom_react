        ...
        <nav aria-label="Breadcrumb" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ol role="list" className="flex items-center space-x-4 py-8">
                    ...
                    <li className="text-sm">
                        <Link to="/categories"  className="font-medium text-gray-500 hover:text-gray-600">
                            New Arrivals
                        </Link>
                        <svg viewBox="0 0 6 20" aria-hidden="true" className="h-5 w-auto text-gray-300">
                                <path d="M4.878 4.34H3.551L.27 16.532h1.327l3.281-12.19z" fill="currentColor" />
                    ...
                    <li className="text-sm">
                        <Link to="/products" aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">
                            Basic Tee
                        </Link>
                    </li>
          </ol>
